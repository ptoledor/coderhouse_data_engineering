...
def send_email(sendgrid_apikey):
    xto_emails = ['ptoledor@msn.com']

    mensaje = Mail(from_email='toledox@gmail.com',
                to_emails=xto_emails,
                subject='Notificación Airflow-Dag ptoledor@coderhouse',
                    html_content='<strong>Se ha agregado un registro a la base redshift ptoledor@coderhouse</strong>')
...
with DAG('agrega_chiste_chuck_norris',
    ...
    kwargs3 = {'sendgrid_apikey': sendgrid_apikey }
    task3 = PythonOperator(task_id='send_email',
